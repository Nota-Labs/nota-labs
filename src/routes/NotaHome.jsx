...
const Navigation = () => (
  <nav className="navbar navbar-expand-lg fixed-top nav_colour">
    ...
    >
      <i className="fas fa-bars" style={{ fontSize: '40px' }} />
    </button>
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ml-auto">
        <li className="nav-item">
          <a
            className="p-2 text-dark scroll"
            href="#about"
            data-toggle="collapse"
            data-target="#navbarSupportedContent"
          >
    ...
    <div className="container">
      <div className="row d-flex">
        <div className="col-12">
          {/* <!-- Content here --> */}
          <h1 className="text_center hero fade-in one">
            People-shaped
            <br />
            digital products
          </h1>
          <p className="text_center hero-tag fade-in two">
            user research • product strategy • rapid prototyping • digital design
          </p>
        </div>
      </div>
    </div>
      ...
      <div className="row section">
        <div className="col-md-8 offset-md-2">
          ...
          <h2 className="font-white">
            <span style={{ fontWeight: '400' }}>We're a team of</span> user-experience consultants
            and product designers.
          </h2>
          <h2 className="font-white">
            <span style={{ fontWeight: '400' }}>We focus on one thing: helping companies</span>{' '}
            design digital products around the needs of their users.
          </h2>
        </div>
      </div>
    </div>
    ...
    <div className="container">
      <div className="row section">
        <div className="col-md-8 offset-md-2">
          ...
          <ul>
            <li className="disc">
              Map your users needs <span style={{ fontWeight: '400' }}>and</span> product
              opportunities,{' '}
              <span style={{ fontWeight: '400' }}>
                using a range of research and workshop activities
              </span>
            </li>
            <li className="disc">
              Make and test prototypes,{' '}
              <span style={{ fontWeight: '400' }}>
                quickly finding the version that is most valuable, viable and intuitive
              </span>
            </li>
            <li className="disc">
              <span style={{ fontWeight: '400' }}>Create</span> UX and design{' '}
              <span style={{ fontWeight: '400' }}>
                assets that your team needs to build the product efficiently and with consistency
              </span>
            </li>
          </ul>
          {/* <!-- Hidden content here --> */}
      ...
      <div className="row section">
        <div className="col-md-8 offset-md-2">
          ...
          <ul>
            <li className="disc">
              <span style={{ fontWeight: '400' }}>
                A high-street bank design a new simplified investment service
              </span>
            </li>
            <li className="disc">
              <span style={{ fontWeight: '400' }}>
                02 redesign their website to increase product findability and customer self-service
              </span>
            </li>
            <li className="disc">
              <span style={{ fontWeight: '400' }}>
                Nationwide speed up customer-servicing by redesigning their digital tool-set
              </span>
            </li>
          </ul>
        </div>
      ...
      <div className="row section">
        ...
        <div className="col-md-4 offset-md-2">
          ...
          <div className="profile_box profile-padding">
            ...
            <p>
              <a href="https://www.linkedin.com/in/ben-simmonds-0312922/" target="_blank">
                <i className="fab fa-linkedin icon-size" />
              </a>
            </p>
          </div>
          {/* <!--<div className="profile_box profile-padding">
        ...
        <div className="col-md-4">
          ...
          <div className="profile_box profile-padding">
            ...
            <p>Design Director</p>
            <p>
              <a href="https://www.linkedin.com/in/jamesodwyer/" target="_blank">
                <i className="fab fa-linkedin icon-size" />
              </a>
            </p>
          </div>
    ...
    <div className="container">
      <div className="row section">
        ...
        <div className="col-md-2">
          ...
          <p>
            <a
              href="https://www.instagram.com/nota_labs/"
              target="_window"
              style={{ background: 'none' }}
            >
              <i className="fab fa-instagram icon-size-white" style={{ marginRight: '20px' }} />
            </a>
            <a href="https://twitter.com/Notalabs1" target="_window" style={{ background: 'none' }}>
              <i className="fab fa-twitter-square icon-size-white" />
            </a>
          </p>
        </div>
